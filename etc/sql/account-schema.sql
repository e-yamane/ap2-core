...
-- PLAN_TRANSACTION
-----------------------------------------------------------------------------
DROP TABLE PLAN_TRANSACTION CASCADE CONSTRAINTS PURGE;
...
ALTER TABLE PLAN_TRANSACTION
    ADD CONSTRAINT PLAN_TRANSACTION_PK
PRIMARY KEY (ID);
...
-- ACTUAL_TRANSACTION
-----------------------------------------------------------------------------
DROP TABLE ACTUAL_TRANSACTION CASCADE CONSTRAINTS PURGE;
...
ALTER TABLE ACTUAL_TRANSACTION
    ADD CONSTRAINT ACTUAL_TRANSACTION_PK
PRIMARY KEY (ID);
