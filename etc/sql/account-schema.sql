...
(
    ...
    PRIMARY KEY (ID),
    CONSTRAINT unq_ENTRY_1 UNIQUE (ACCOUNT_ID, TRANSACTION_ID)
);
...
COMMENT ON TABLE PLAN_TRANSACTION IS '予定トランザクション';
COMMENT ON COLUMN PLAN_TRANSACTION.ID IS 'OID';
COMMENT ON COLUMN PLAN_TRANSACTION.PROCESS_ID IS '取引番号';


-----------------------------------------------------------------------------
-- ACTUAL_TRANSACTION
-----------------------------------------------------------------------------
DROP TABLE ACTUAL_TRANSACTION;
...
COMMENT ON TABLE ACTUAL_TRANSACTION IS '実績トランザクション';
COMMENT ON COLUMN ACTUAL_TRANSACTION.ID IS 'OID';
COMMENT ON COLUMN ACTUAL_TRANSACTION.PROCESS_ID IS '取引番号';
