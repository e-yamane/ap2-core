...
(
ID BIGINT NOT NULL COMMENT 'OID',
AMOUNT_UNIT_ID BIGINT COMMENT '移動量 数量尺度ID',
AMOUNT_Q_VALUE BIGINT NOT NULL COMMENT '移動量 量 量(整数)',
AMOUNT_Q_SCALE INTEGER NOT NULL COMMENT '移動量 量 小数点位置。正の数なら左へ、負の数なら右へ移動させる',
